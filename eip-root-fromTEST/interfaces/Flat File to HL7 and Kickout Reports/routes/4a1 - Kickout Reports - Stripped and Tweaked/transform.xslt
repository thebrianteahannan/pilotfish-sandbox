...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="3.1">
	...
	<xsl:template match="/XCSData">
		...
		<!--
			<xsl:for-each select="Patient-Demographics | Patient-Demographics-v2">
				<PatientDemographics>
					<admAcctNum>
			...
			<xsl:for-each select="Guarantor | Guarantor-v2">
				<Guarantor>
					<admAcctNum>
						<xsl:value-of select="cpcs-account-"/>
					</admAcctNum>
			...
			<xsl:for-each select="Diagnosis-Codes-v3">
				<DiagnosisCodes>
					<xsl:copy-of select="radAcctNum | Diag1 | Diag1CodeSet"/>
					<xsl:for-each select="Diag2 | Diag3 | Diag4 | Diag5 | Diag6 | Diag7 | Diag8 | Diag9 | Diag10 | Diag11 | Diag12">
						<Diag2>
							<xsl:value-of select="."/>
						</Diag2>
					</xsl:for-each>
			...
			<xsl:for-each select="Diagnosis-Codes | Diagnosis-Codes-v2">
				<DiagnosisCodes>
					<radAcctNum>
						<xsl:value-of select="cpcs-account-"/>
					</radAcctNum>
