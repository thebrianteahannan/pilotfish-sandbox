...
length format of Version 005 Release 010 Industry Implementation X231A1.
...
disk, nor to use these files to republish the copyrighted WPC implementation
guides.
...
WPC and Licensee.  The Table Data that is licensed shall be considered an
"as is" Work.  WPC and DISA doe not guarantee that the Table Data will meet
"all requirements" of Licensee's business. WPC shall not be responsible for
