...
async function refresh() {
  ...
  try {
    ...
    renderFiles("json-list", "json-view", results.json || []);
    renderFiles("oci-list", "oci-view", results.oci || []);
  } catch (_) {
...
async function loadHealth() {
  ...
  try {
    ...
    bits.push(h.oci ? "Object Storage up" : "Object Storage starting");
...
if (form) {
  form.addEventListener("submit", async (e) => {
    ...
    try {
      ...
      try {
        await getJson("/api/wait-results?contains=PATCLAIM001&timeout=90");
