#!/usr/bin/env python3
"""Screenshot EDI 835 OCI Bucket V2 route diagrams and assemble a PDF.
...
BRAND = "PILOTFISH  ·  EDI 835 OCI BUCKET"
BASE = "http://127.0.0.1:8105"
CHROME = "/Applications/Google Chrome.app/Contents/MacOS/Google Chrome"
ROUTES = [
    ("1 — SFTP Poll And Stage (Overview)", "1-sftp-poll-and-stage", "route1-overview.png"),
    ("2 — Split And Put Objects", "2-split-and-put-objects", "route2.png"),
]
MARGIN = 0.28 * inch
HEADER_H = 0.36 * inch
SLICE_OVERLAP_PX = 48
...
WINDOW_BY_CONFIG = {
    "compact": {
        ...
        "2-split-and-put-objects": (2400, 2800),
    },
    "changed": {
        "1-sftp-poll-and-stage": (2400, 2800),
        "2-split-and-put-objects": (2600, 3400),
    },
    "all": {
        "1-sftp-poll-and-stage": (2600, 3600),
        "2-split-and-put-objects": (2800, 4200),
    },
}
