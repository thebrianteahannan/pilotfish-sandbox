#!/usr/bin/env python3
"""Screenshot EDI 834 CSV Excel Conversion V2 route diagrams and assemble a PDF.
...
DOCS = ROOT / "documents"
PDF_NAME = "EDI834_CSV_Excel_V2_Route_Diagrams.pdf"
BRAND = "PILOTFISH  ·  EDI 834 CSV EXCEL CONVERSION"
BASE = "http://127.0.0.1:8140"
CHROME = "/Applications/Google Chrome.app/Contents/MacOS/Google Chrome"
ROUTES = [
    ("1 — CSV TXT to EDI 834", "1-csv-txt-to-edi-834", "route1.png"),
    ("2 — EDI 834 to CSV", "2-edi-834-to-csv", "route2.png"),
]
MARGIN = 0.28 * inch
HEADER_H = 0.36 * inch
SLICE_OVERLAP_PX = 48
...
WINDOW_BY_CONFIG = {
    "compact": {
        "1-csv-txt-to-edi-834": (2200, 2200),
        "2-edi-834-to-csv": (2200, 1800),
    },
    "changed": {
        "1-csv-txt-to-edi-834": (2400, 2800),
        "2-edi-834-to-csv": (2400, 2200),
    },
    "all": {
        "1-csv-txt-to-edi-834": (2600, 3600),
        "2-edi-834-to-csv": (2600, 2800),
    },
}
...
def wait_health(timeout=30):
    ...
    while time.time() < deadline:
        try:
            ...
            time.sleep(0.5)
    raise SystemExit("Web UI not reachable on :8140")
