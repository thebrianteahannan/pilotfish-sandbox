#!/usr/bin/env python3
"""Screenshot EDI 837 Claim Scrub V2 route diagrams and assemble a PDF.
...
DOCS = ROOT / "documents"
PDF_NAME = "EDI837_Claim_Scrub_V2_Route_Diagrams.pdf"
BRAND = "PILOTFISH  ·  EDI 837 CLAIM SCRUB"
BASE = "http://127.0.0.1:8115"
CHROME = "/Applications/Google Chrome.app/Contents/MacOS/Google Chrome"
ROUTES = [
    ("1 — Poll SQL Server Claims (Overview)", "1-poll-sql-server-claims", "route1-overview.png"),
    ("2 — Scrub Claim And Route", "2-scrub-claim-and-route", "route2.png"),
]
MARGIN = 0.28 * inch
HEADER_H = 0.36 * inch
SLICE_OVERLAP_PX = 48
...
WINDOW_BY_CONFIG = {
    "compact": {
        "1-poll-sql-server-claims": (2200, 2200),
        "2-scrub-claim-and-route": (2800, 4200),
    },
    "changed": {
        "1-poll-sql-server-claims": (2400, 2800),
        "2-scrub-claim-and-route": (3000, 4800),
    },
    "all": {
        "1-poll-sql-server-claims": (2600, 3600),
        "2-scrub-claim-and-route": (3200, 5600),
    },
}
...
def wait_health(timeout=30):
    ...
    while time.time() < deadline:
        try:
            ...
            time.sleep(0.5)
    raise SystemExit("Web UI not reachable on :8115")
