...
TYPE_BY_CLASS = {
    ...
    "com.pilotfish.eip.modules.transform.hl7.HL7TransformationProcessor": "HL7 Transformation",
    "com.pilotfish.eip.modules.file.EOLProcessor": "End of Line",
}
...
def main():
    ...
    iface = root / "eip-root" / "interfaces" / "EDI 276 277 Claim Status"
