#!/usr/bin/env python3
"""Screenshot EDI 276/277 Claim Status V2 route diagrams and assemble a PDF.
...
DOCS = ROOT / "documents"
PDF_NAME = "EDI276_277_V2_Route_Diagrams.pdf"
BRAND = "PILOTFISH  ·  EDI 276/277 CLAIM STATUS"
BASE = "http://127.0.0.1:8127"
CHROME = "/Applications/Google Chrome.app/Contents/MacOS/Google Chrome"
ROUTES = [
    ("1 — Intake And Lookup (Overview)", "1-intake-and-lookup", "route1-overview.png"),
    ("2 — Emit 277 And Bucket", "2-emit-277-and-bucket", "route2.png"),
]
MARGIN = 0.28 * inch
HEADER_H = 0.36 * inch
SLICE_OVERLAP_PX = 48
...
WINDOW_BY_CONFIG = {
    "compact": {
        "1-map-837p-to-qcare": (2200, 2200),
        "1-map-837p-to-qcare": (2400, 2800),
    },
    "changed": {
        "1-map-837p-to-qcare": (2400, 2800),
        "1-map-837p-to-qcare": (2600, 3400),
    },
    "all": {
        "1-map-837p-to-qcare": (2600, 3600),
        "1-map-837p-to-qcare": (2800, 4200),
    },
}
...
def wait_health(timeout=30):
    ...
    while time.time() < deadline:
        try:
            ...
            time.sleep(0.5)
    raise SystemExit("Web UI not reachable on :8127")
