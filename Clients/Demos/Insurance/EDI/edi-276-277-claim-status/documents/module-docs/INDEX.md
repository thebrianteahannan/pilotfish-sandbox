# Module documentation — `edi-276-277-claim-status`

Deep-dive PDFs for every PilotFish module used by this interface.
Synced `2026-08-13T07:55:32Z` from `/Users/brianhannan/Documents/PilotFish Documentation/Documents`.

Re-sync after route changes:

```bash
python3 tools/sync_module_docs.py --root Clients/Demos/Insurance/EDI/edi-276-277-claim-status
```
