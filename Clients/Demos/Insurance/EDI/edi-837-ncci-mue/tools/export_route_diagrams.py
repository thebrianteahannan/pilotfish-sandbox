#!/usr/bin/env python3
"""Screenshot EDI 837 NCCI MUE V2 route diagrams and assemble a PDF.
...
DOCS = ROOT / "documents"
PDF_NAME = "EDI837_NCCI_MUE_V2_Route_Diagrams.pdf"
BRAND = "PILOTFISH  ·  EDI 837 NCCI MUE"
BASE = "http://127.0.0.1:8131"
CHROME = "/Applications/Google Chrome.app/Contents/MacOS/Google Chrome"
ROUTES = [
    {
        "title": "1 — Poll And Score MUE (Overview)",
        "route": "1-poll-and-score-mue",
        "file": "route1-overview.png",
        "collapse": "all",
        "window": {"compact": (2200, 2200), "changed": (2400, 2800), "all": (2600, 3600)},
    },
    {
        "title": "1 · Extract 837 line",
        "route": "1-poll-and-score-mue",
    ...
    {
        "title": "1 · MUE catalog lookup",
        "route": "1-poll-and-score-mue",
        "file": "route1-lookup.png",
        "group": "lookup",
        "window": {"compact": (2200, 2000), "changed": (2400, 2600), "all": (2600, 3200)},
    },
    {
        "title": "1 · MUE decision",
        "route": "1-poll-and-score-mue",
    ...
    {
        "title": "2 — Route MUE Decisions",
        "route": "2-route-mue-decisions",
        "file": "route2.png",
        "window": {"compact": (2400, 2800), "changed": (2600, 3400), "all": (2800, 4200)},
    },
]
MARGIN = 0.28 * inch
HEADER_H = 0.36 * inch
...
def wait_health(timeout=30):
    ...
    while time.time() < deadline:
        try:
            ...
            time.sleep(0.5)
    raise SystemExit("Web UI not reachable on :8131")
