#!/usr/bin/env python3
"""Screenshot EDI 835 Payment Integrity V2 route diagrams and assemble a PDF.
...
DOCS = ROOT / "documents"
PDF_NAME = "EDI835_Payment_Integrity_V2_Route_Diagrams.pdf"
BRAND = "PILOTFISH  ·  EDI 835 PAYMENT INTEGRITY"
BASE = "http://127.0.0.1:8111"
CHROME = "/Applications/Google Chrome.app/Contents/MacOS/Google Chrome"
ROUTES = [
    ("1 — Poll And Score Remits (Overview)", "1-poll-and-score-remits", "route1-overview.png"),
    ("2 — Route Remit Decisions", "2-route-remit-decisions", "route2.png"),
]
MARGIN = 0.28 * inch
HEADER_H = 0.36 * inch
SLICE_OVERLAP_PX = 48
...
WINDOW_BY_CONFIG = {
    "compact": {
        "1-poll-and-score-remits": (2200, 2200),
        "2-route-remit-decisions": (2400, 2800),
    },
    "changed": {
        "1-poll-and-score-remits": (2400, 2800),
        "2-route-remit-decisions": (2600, 3400),
    },
    "all": {
        "1-poll-and-score-remits": (2600, 3600),
        "2-route-remit-decisions": (2800, 4200),
    },
}
