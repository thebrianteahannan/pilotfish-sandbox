#!/usr/bin/env python3
"""Screenshot EDI 837P to QCare V2 route diagrams and assemble a PDF.
...
DOCS = ROOT / "documents"
PDF_NAME = "EDI837P_QCare_V2_Route_Diagrams.pdf"
BRAND = "PILOTFISH  ·  EDI 837P TO QCARE"
BASE = "http://127.0.0.1:8125"
CHROME = "/Applications/Google Chrome.app/Contents/MacOS/Google Chrome"
ROUTES = [
    ("1 — Map 837P To QCare (Overview)", "1-map-837p-to-qcare", "route1-overview.png"),
]
MARGIN = 0.28 * inch
HEADER_H = 0.36 * inch
SLICE_OVERLAP_PX = 48
...
def wait_health(timeout=30):
    ...
    while time.time() < deadline:
        try:
            ...
            time.sleep(0.5)
    raise SystemExit("Web UI not reachable on :8125")
