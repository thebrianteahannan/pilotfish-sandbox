#!/usr/bin/env python3
"""Screenshot EDI 837 NCCI PTP V2 route diagrams and assemble a PDF.
...
DOCS = ROOT / "documents"
PDF_NAME = "EDI837_NCCI_PTP_V2_Route_Diagrams.pdf"
BRAND = "PILOTFISH  ·  EDI 837 NCCI PTP"
BASE = "http://127.0.0.1:8133"
CHROME = "/Applications/Google Chrome.app/Contents/MacOS/Google Chrome"
ROUTES = [
    {
        "title": "1 — Poll And Score PTP (Overview)",
        "route": "1-poll-and-score-ptp",
        "file": "route1-overview.png",
        "collapse": "all",
        "window": {"compact": (2200, 2200), "changed": (2400, 2800), "all": (2600, 3600)},
    },
    {
        "title": "1 · Extract 837 pair",
        "route": "1-poll-and-score-ptp",
    ...
    {
        "title": "2 — Route PTP Decisions",
        "route": "2-route-ptp-decisions",
        "file": "route2.png",
...
def wait_health(timeout=30):
    ...
    while time.time() < deadline:
        try:
            ...
            time.sleep(0.5)
    raise SystemExit("Web UI not reachable on :8133")
