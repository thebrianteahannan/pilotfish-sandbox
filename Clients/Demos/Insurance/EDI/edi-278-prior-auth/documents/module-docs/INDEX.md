# Module documentation — `edi-278-prior-auth`

Deep-dive PDFs for every PilotFish module used by this interface.
Synced `2026-08-13T07:19:54Z` from `/Users/brianhannan/Documents/PilotFish Documentation/Documents`.

Re-sync after route changes:

```bash
python3 tools/sync_module_docs.py --root Clients/Demos/Insurance/EDI/edi-278-prior-auth
```
...
| Processor | End of Line Conversion | [`PilotFish-End-of-Line-Conversion-Reference-26R1.11.pdf`](PilotFish-End-of-Line-Conversion-Reference-26R1.11.pdf) | `EOLProcessor` |
...
| Processor | HL7 Transformation | *(missing)* | `HL7TransformationProcessor` |
| Processor | XML Formatting | [`PilotFish-XML-Formatting-Reference-26R1.11.pdf`](PilotFish-XML-Formatting-Reference-26R1.11.pdf) | `XMLFormattingProcessor` |
...
| Transport | NULL Transport | [`PilotFish-NULL-Transport-Reference-26R1.11.pdf`](PilotFish-NULL-Transport-Reference-26R1.11.pdf) | `NullTransport` |

## Missing

- Processor|HL7 Transformation (com.pilotfish.eip.modules.transform.hl7.HL7TransformationProcessor)
