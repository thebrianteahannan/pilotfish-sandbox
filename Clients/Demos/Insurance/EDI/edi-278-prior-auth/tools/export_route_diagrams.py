#!/usr/bin/env python3
"""Screenshot EDI 278 Prior Auth V2 route diagrams and assemble a PDF.
...
ROUTES = [
    ("1 — Poll And Score Auths (Overview)", "1-poll-and-score-auths", "route1-overview.png"),
    ("2 — Route Auth Decisions", "2-route-auth-decisions", "route2.png"),
]
MARGIN = 0.28 * inch
HEADER_H = 0.36 * inch
SLICE_OVERLAP_PX = 48
...
WINDOW_BY_CONFIG = {
    "compact": {
        "1-poll-and-score-auths": (2200, 2200),
        "2-route-auth-decisions": (2400, 2800),
    },
    "changed": {
        "1-poll-and-score-auths": (2400, 2800),
        "2-route-auth-decisions": (2600, 3400),
    },
    "all": {
        "1-poll-and-score-auths": (2600, 3600),
        "2-route-auth-decisions": (2800, 4200),
    },
}
