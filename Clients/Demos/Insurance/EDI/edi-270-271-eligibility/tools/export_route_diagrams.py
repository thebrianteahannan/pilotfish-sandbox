#!/usr/bin/env python3
"""Screenshot EDI 270/271 Eligibility V2 route diagrams and assemble a PDF.
...
BRAND = "PILOTFISH  ·  EDI 270/271 ELIGIBILITY"
BASE = "http://127.0.0.1:8107"
CHROME = "/Applications/Google Chrome.app/Contents/MacOS/Google Chrome"
ROUTES = [
    ("1 — Eligibility 270 271 API (Overview)", "1-eligibility-270-271-api", "route1-overview.png"),
    ("1 — Eligibility 270 271 API (Detail)", "1-eligibility-270-271-api", "route1-detail.png"),
]
MARGIN = 0.28 * inch
HEADER_H = 0.36 * inch
SLICE_OVERLAP_PX = 48
...
WINDOW_BY_CONFIG = {
    "compact": {
        "1-eligibility-270-271-api": (2400, 2600),
    },
    "changed": {
        "1-eligibility-270-271-api": (2400, 2800),
    },
    "all": {
        "1-eligibility-270-271-api": (2600, 3600),
    },
}
