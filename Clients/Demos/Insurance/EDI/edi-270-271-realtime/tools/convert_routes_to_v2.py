...
TYPE_BY_CLASS = {
    ...
    "com.pilotfish.eip.modules.db.DatabaseSqlTransport": "Database (SQL)",
    ...
    "com.pilotfish.eip.modules.transform.XMLFormattingProcessor": "XML Formatting",
    "com.pilotfish.eip.modules.internal.NullRoutingModule": "Null Router",
    "com.pilotfish.eip.modules.transform.CSVTransformationProcessor": "CSV",
    "com.pilotfish.eip.modules.json.JSONTransformationProcessor": "JSON",
    "com.pilotfish.eip.modules.internal.SaveDataToAttributeProcessor": "Data Attribute Swapper",
    "com.pilotfish.eip.modules.transform.edi.EDITransformationModule": "EDI",
    "com.pilotfish.eip.modules.other.XPathForkingModule": "XPath",
    ...
    "com.pilotfish.eip.modules.routing.XPathRoutingModule": "Conditional Node Router",
    "com.pilotfish.eip.modules.db.DatabaseSqlProcessor": "Database (SQL)",
    "com.pilotfish.eip.modules.other.NullTransport": "Null",
    "com.pilotfish.eip.modules.internal.TransactionAttributePopulationProcessor": "Attribute Population",
    "com.pilotfish.eip.modules.file.ftp.FTPListener": "Encrypted FTP (JSCH SSH/SFTP)",
    "com.pilotfish.eip.modules.http.rest.RESTfulWebServiceListener": "RESTful Web Service",
    "com.pilotfish.eip.modules.transform.EDITransformationProcessor": "EDI Transformation",
    "com.pilotfish.eip.modules.internal.SynchronousResponseTransport": "Synchronous Response",
    "com.pilotfish.eip.modules.http.HttpResponseCodeProcessor": "HTTP Response Status",
    "com.pilotfish.eip.modules.http.AddHttpResponseHeadersProcessor": "HTTP Response Headers",
...
def expression_xpath(condition_el: ET.Element | None) -> str:
    ...
    if ognl is not None and text_of(ognl):
        return text_of(ognl)
...
class Converter:
    ...
    def convert(self) -> None:
        ...
        for target in find_all(root, "Target"):
            ...
            posts_wrap = find_child(target, "PostProcessors")
            for proc in find_all(posts_wrap, "Processor"):
                chain.append(
                    (
                        "processor",
                        proc.attrib["class"],
...
def main():
    ...
    iface = root / "eip-root" / "interfaces" / "EDI 270 271 Realtime"
    formats = iface / "formats"
    targets = [iface]
    demo_root = root / "pilotfish" / "demo-eip-root"
    if (demo_root / "routes").is_dir():
        targets.append(demo_root)

    for target in targets:
        formats_dir = target / "formats" if (target / "formats").is_dir() else formats
        routes_dir = target / "routes"
        if not routes_dir.is_dir():
            continue
        for route in sorted(routes_dir.iterdir()):
