#!/usr/bin/env python3
"""Screenshot EDI 270/271 Realtime Eligibility V2 route diagrams and assemble a PDF.
...
DOCS = ROOT / "documents"
PDF_NAME = "EDI270_271_Realtime_V2_Route_Diagrams.pdf"
BRAND = "PILOTFISH  ·  EDI 270/271 REALTIME ELIGIBILITY"
BASE = "http://127.0.0.1:8121"
CHROME = "/Applications/Google Chrome.app/Contents/MacOS/Google Chrome"
ROUTES = [
    ("1 — Realtime Eligibility Check (Overview)", "1-realtime-eligibility-check", "route1-overview.png"),
    ("1 — Realtime Eligibility Check (Detail)", "1-realtime-eligibility-check", "route1-detail.png"),
]
MARGIN = 0.28 * inch
HEADER_H = 0.36 * inch
SLICE_OVERLAP_PX = 48
...
WINDOW_BY_CONFIG = {
    "compact": {
        "1-realtime-eligibility-check": (2400, 2800),
    },
    "changed": {
        "1-realtime-eligibility-check": (2400, 3200),
    },
    "all": {
        "1-realtime-eligibility-check": (2600, 3800),
    },
}
...
def wait_health(timeout=30):
    ...
    while time.time() < deadline:
        try:
            ...
            time.sleep(0.5)
    raise SystemExit("Web UI not reachable on :8121")
