# Module documentation — `edi-999-ta1-ack-triage`

Deep-dive PDFs for every PilotFish module used by this interface.
Synced `2026-08-12T18:42:20Z` from `/Users/brianhannan/Documents/PilotFish Documentation/Documents`.

Re-sync after route changes:

```bash
python3 tools/sync_module_docs.py --root Clients/Demos/edi-999-ta1-ack-triage
```
