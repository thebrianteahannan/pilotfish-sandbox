...
```bash
python3 tools/record_module_replay.py --root Clients/Demos/edi-999-ta1-ack-triage
```

## Progressive stage (Web UI early)

```bash
cd Clients/Demos/edi-999-ta1-ack-triage
...
python3 Clients/Demos/edi-999-ta1-ack-triage/tools/progressive_build_theater.py 5
```
...
python3 tools/publish_route_progress.py \
  --root Clients/Demos/edi-999-ta1-ack-triage \
