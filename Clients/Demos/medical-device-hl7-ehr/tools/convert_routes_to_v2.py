...
TYPE_BY_CLASS = {
    ...
    "com.pilotfish.eip.modules.hl7.HL7TCPListener": "HL7 LLP",
    "com.pilotfish.eip.modules.hl7.HL7SimpleTransport": "HL7 MLLP (Simple)",
    "com.pilotfish.eip.modules.hl7.HL7TCPTransport": "HL7 LLP",
    "com.pilotfish.eip.modules.hl7.HL7ValidationProcessor": "HL7 Validation",
    "com.pilotfish.eip.modules.internal.NullRoutingModule": "All Targets",
}
...
def main():
    ...
    iface = root / "eip-root/interfaces/Medical Device HL7 EHR"
    ...
    for base in targets:
        formats_dir = base / "formats" if (base / "formats").is_dir() else formats
        for route in sorted((base / "routes").iterdir()):
            if not (route / "route.xml").is_file():
                continue
            print("Converting", base.name, "→", route.name)
