...
ROUTES = [
    ("1 — Map 837P To QCare", "1-map-837p-to-qcare", "route1.png"),
]
MARGIN = 0.28 * inch
HEADER_H = 0.36 * inch
SLICE_OVERLAP_PX = 48
...
WINDOW_BY_CONFIG = {
    "compact": {"1-map-837p-to-qcare": (1800, 2200)},
    "changed": {"1-map-837p-to-qcare": (2200, 3200)},
    "all": {"1-map-837p-to-qcare": (2400, 4200)},
}
