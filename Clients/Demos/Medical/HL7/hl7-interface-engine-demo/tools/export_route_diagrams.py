...
DOCS = ROOT / "documents"
PDF_NAME = "HL7_Interface_Engine_V2_Route_Diagrams.pdf"
BRAND = "PILOTFISH  ·  HL7 INTERFACE ENGINE DEMO"
BASE = "http://127.0.0.1:8142"
CHROME = "/Applications/Google Chrome.app/Contents/MacOS/Google Chrome"
ROUTES = [
    ("1 — Hospital HL7 To Database", "1-hospital-hl7-to-database", "route1.png"),
]
MARGIN = 0.28 * inch
HEADER_H = 0.36 * inch
SLICE_OVERLAP_PX = 48
...
WINDOW_BY_CONFIG = {
    "compact": {"1-hospital-hl7-to-database": (2200, 1800)},
    "changed": {"1-hospital-hl7-to-database": (2400, 2800)},
    "all": {"1-hospital-hl7-to-database": (2600, 3400)},
}
...
def wait_health(timeout=30):
    ...
    while time.time() < deadline:
        try:
            ...
            time.sleep(0.5)
    raise SystemExit("Web UI not reachable on :8142")
