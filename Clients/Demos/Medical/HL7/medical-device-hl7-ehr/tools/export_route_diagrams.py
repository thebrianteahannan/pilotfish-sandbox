...
DOCS = ROOT / "documents"
PDF_NAME = "DeviceHL7EHR_V2_Route_Diagrams.pdf"
BRAND = "PILOTFISH  ·  MEDICAL DEVICE HL7 EHR"
BASE = "http://127.0.0.1:8101"
CHROME = "/Applications/Google Chrome.app/Contents/MacOS/Google Chrome"
ROUTES = [
    ("1 — Process Device ORU LLP", "1-process-device-oru-llp", "route1.png"),
]
MARGIN = 0.28 * inch
HEADER_H = 0.36 * inch
SLICE_OVERLAP_PX = 48
...
WINDOW_BY_CONFIG = {
    "compact": {"1-process-device-oru-llp": (2000, 1600)},
    "changed": {"1-process-device-oru-llp": (2200, 2400)},
    "all": {"1-process-device-oru-llp": (2400, 3200)},
}
...
def wait_health(timeout=30):
    ...
    while time.time() < deadline:
        try:
            ...
            time.sleep(0.5)
    raise SystemExit("Web UI not reachable on :8101")
