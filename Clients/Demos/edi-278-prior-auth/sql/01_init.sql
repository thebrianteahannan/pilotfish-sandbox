...
CREATE TABLE dbo.AuthCatalog (
    ...
    DefaultDisposition   NVARCHAR(20)   NOT NULL, -- APPROVE | DENY | PEND
...
VALUES
    (N'27447', N'Total knee arthroplasty', 1, 1, N'APPROVE', N'Requires clinical attachment (clinic note / imaging)'),
...
-- Seeded open auth traces that the sample 278 file will drive.
