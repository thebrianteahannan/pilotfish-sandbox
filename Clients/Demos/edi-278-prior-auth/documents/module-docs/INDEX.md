...
```bash
python3 tools/sync_module_docs.py --root Clients/Demos/edi-278-prior-auth
```
...
| Processor | HL7TransformationProcessor | *(missing)* | `HL7TransformationProcessor` |
...
- Processor|HL7TransformationProcessor (com.pilotfish.eip.modules.transform.hl7.HL7TransformationProcessor)
