#!/usr/bin/env python3
"""Screenshot SQL Server XML Export V2 route diagrams and assemble a PDF.
...
DOCS = ROOT / "documents"
PDF_NAME = "SQL_Server_PilotFish_XML_Export_V2_Route_Diagrams.pdf"
BRAND = "PILOTFISH  ·  SQL SERVER XML EXPORT"
BASE = "http://127.0.0.1:8137"
CHROME = "/Applications/Google Chrome.app/Contents/MacOS/Google Chrome"
ROUTES = [
    ("1 — Export Captures to XML", "1-export-captures-to-xml", "route1.png"),
]
MARGIN = 0.28 * inch
HEADER_H = 0.36 * inch
SLICE_OVERLAP_PX = 48
...
WINDOW_BY_CONFIG = {
    "compact": {"1-export-captures-to-xml": (1800, 1400)},
    "changed": {"1-export-captures-to-xml": (2200, 1800)},
    "all": {"1-export-captures-to-xml": (2400, 2200)},
}
...
def wait_health(timeout=30):
    ...
    while time.time() < deadline:
        try:
            ...
            time.sleep(0.5)
    raise SystemExit("Web UI not reachable on :8137")
