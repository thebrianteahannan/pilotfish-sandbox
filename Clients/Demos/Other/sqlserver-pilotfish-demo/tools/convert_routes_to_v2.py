...
TYPE_BY_CLASS = {
    ...
    "com.pilotfish.eip.modules.http.HttpPostListener": "HTTP Post",
    "com.pilotfish.eip.modules.messaging.rabbitmq.RabbitMQTransport": "RabbitMQ",
...
def main():
    ...
    iface = root / "eip-root" / "interfaces" / "SQL Server PilotFish XML Export"
