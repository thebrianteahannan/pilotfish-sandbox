...
```bash
python3 tools/export_construction_video.py --root Clients/Demos/Other/csv-sftp-to-sql
# transcript only:
python3 tools/export_construction_transcript_pdf.py --root Clients/Demos/Other/csv-sftp-to-sql
# or automatically via:
python3 tools/update_build_status.py --root Clients/Demos/Other/csv-sftp-to-sql --complete
```
