# Module documentation — `csv-sftp-to-sql`

Deep-dive PDFs for every PilotFish module used by this interface.
Synced `2026-08-12T19:23:09Z` from `/Users/brianhannan/Documents/PilotFish Documentation/Documents`.

Re-sync after route changes:

```bash
python3 tools/sync_module_docs.py --root Clients/Demos/Other/csv-sftp-to-sql
```
...
| Processor | CSV | [`PilotFish-CSV-XML-Guide-26R1.11.pdf`](PilotFish-CSV-XML-Guide-26R1.11.pdf) | `CSVTransformationProcessor` |
