# Module documentation — `csv-to-json`

Deep-dive PDFs for every PilotFish module used by this interface.
Synced `2026-08-12T16:57:29Z` from `/Users/brianhannan/Documents/PilotFish Documentation/Documents`.

Re-sync after route changes:

```bash
python3 tools/sync_module_docs.py --root Clients/Demos/Other/csv-to-json
```
