"""Medical Lab HL7 LLP demo Web UI."""
...
LLP_PORT = int(os.environ.get("EIP_LLP_PORT", "2575"))
INBOUND_DIR = Path(os.environ.get("INBOUND_DIR", "/output/inbound"))
OUTBOUND_DIR = Path(os.environ.get("OUTBOUND_DIR", "/output/meditech-outbound"))
RECEIVED_DIR = Path(os.environ.get("RECEIVED_DIR", "/output/meditech-received"))
...
ROUTE_PDF_NAME = os.environ.get("ROUTE_PDF_NAME", "LabHL7LLP_V2_Route_Diagrams.pdf")
CAPABILITY_PDF_NAME = os.environ.get("CAPABILITY_PDF_NAME", "LabHL7LLP_Capability_Brief.pdf")
    ...
    return jsonify(
        {
            ...
            "meditechReceived": list_hl7(RECEIVED_DIR),
        }
    )
