...
DOCS = ROOT / "documents"
PDF_NAME = "EDI837_V2_Route_Diagrams.pdf"
BRAND = "PILOTFISH  ·  EDI 837 DEMO"
BASE = "http://127.0.0.1:8095"
CHROME = "/Applications/Google Chrome.app/Contents/MacOS/Google Chrome"
ROUTES = [
    ("1 — Poll SQL Server Claims", "1-poll-sql-server-claims", "route1.png"),
    ("2 — Generate 837 And SNIP", "2-generate-837-and-snip", "route2.png"),
]
MARGIN = 0.28 * inch
TITLE_H = 0.42 * inch
