#!/usr/bin/env python3
"""Screenshot V2 route diagrams and assemble a PDF that fills each page.
...
DOCS = ROOT / "documents"
PDF_NAME = "FHIR_R4_Platform_V2_Route_Diagrams.pdf"
TITLE = "FHIR R4 Platform — V2 Route Diagrams"
BRAND = "PILOTFISH  ·  FHIR R4 PLATFORM"
...
WINDOW_BY_CONFIG = {
    "compact": {
        "1-fhir-r4-rest-platform": (2600, 1600),
        "2-fhir-outbound-client": (2000, 1200),
    },
    "changed": {
        "1-fhir-r4-rest-platform": (2800, 3200),
        "2-fhir-outbound-client": (2200, 1800),
    },
    "all": {
        "1-fhir-r4-rest-platform": (3000, 4200),
        "2-fhir-outbound-client": (2400, 2400),
    },
}
