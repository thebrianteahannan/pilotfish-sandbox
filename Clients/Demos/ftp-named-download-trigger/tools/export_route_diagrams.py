#!/usr/bin/env python3
"""Screenshot FTP Named Download Trigger V2 route diagrams and assemble a PDF.
...
DOCS = ROOT / "documents"
PDF_NAME = "FTP_Named_Download_Trigger_V2_Route_Diagrams.pdf"
BRAND = "PILOTFISH  ·  FTP NAMED DOWNLOAD TRIGGER"
BASE = "http://127.0.0.1:8113"
CHROME = "/Applications/Google Chrome.app/Contents/MacOS/Google Chrome"
ROUTES = [
    ("1 — Parse Control And Trigger Download", "1-parse-control-and-trigger-download", "route1.png"),
    ("2 — Download Named File From SFTP", "2-download-named-file-from-sftp", "route2.png"),
]
MARGIN = 0.28 * inch
HEADER_H = 0.36 * inch
SLICE_OVERLAP_PX = 48
...
WINDOW_BY_CONFIG = {
    "compact": {
        "1-parse-control-and-trigger-download": (1800, 1800),
        "2-download-named-file-from-sftp": (1800, 1400),
    },
    "changed": {
        "1-parse-control-and-trigger-download": (2200, 2800),
        "2-download-named-file-from-sftp": (2200, 2200),
    },
    "all": {
        "1-parse-control-and-trigger-download": (2400, 4000),
        "2-download-named-file-from-sftp": (2400, 3200),
    },
}
...
def wait_health(timeout=30):
    ...
    while time.time() < deadline:
        try:
            ...
            time.sleep(0.5)
    raise SystemExit("Web UI not reachable on :8113")
