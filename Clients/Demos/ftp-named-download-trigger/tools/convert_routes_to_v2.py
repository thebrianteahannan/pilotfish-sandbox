...
TYPE_BY_CLASS = {
    ...
    "com.pilotfish.eip.modules.file.ftp.FTPListener": "FTP / SFTP",
    ...
    "com.pilotfish.eip.modules.internal.TransactionAttributePopulationProcessor": "Transaction Attribute Population",
    "com.pilotfish.eip.modules.internal.ListenerTriggeringProcessor": "Listener Trigger",
    "com.pilotfish.eip.modules.internal.NullRoutingModule": "Null Routing",
...
def main():
    ...
    iface = root / "eip-root" / "interfaces" / "FTP Named Download Trigger"
