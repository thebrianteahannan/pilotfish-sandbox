...
| Category | Path | Demos |
|----------|------|--------|
| **Insurance / EDI** | `Insurance/EDI/` | `edi-270-271-eligibility`, `edi-270-271-realtime`, `edi-276-277-claim-status`, `edi-278-prior-auth`, `edi-csv-excel-834`, `edi-835-oci-bucket`, `edi-835-payment-integrity`, `edi-837-claim-scrub`, `edi-837-snip-sqlserver`, `edi-837p-qcare`, `edi-999-ta1-ack-triage`, `xml-to-edi-834` |
| **Medical / HL7** | `Medical/HL7/` | `doc-healthcare-hl7-workflow`, `hl7-healthcare-automation`, `hl7-interface-engine-demo`, `medical-device-hl7-ehr`, `medical-lab-hl7-llp` |
