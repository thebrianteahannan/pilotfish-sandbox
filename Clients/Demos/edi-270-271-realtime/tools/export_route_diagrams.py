...
TITLE = "EDI 270/271 Realtime — V2 Route Diagrams"
BRAND = "PILOTFISH  ·  EDI 270/271 REALTIME"
BASE = "http://127.0.0.1:8121"
CHROME = "/Applications/Google Chrome.app/Contents/MacOS/Google Chrome"
ROUTES = [
    {
        "title": "1 — Realtime Eligibility Check (Overview)",
        "route": "1-realtime-eligibility-check",
    ...
    {
        "title": "1 · Payer Round-Trip + Parse",
        "route": "1-realtime-eligibility-check",
        "file": "route1-payer.png",
        "group": "payer-roundtrip",
