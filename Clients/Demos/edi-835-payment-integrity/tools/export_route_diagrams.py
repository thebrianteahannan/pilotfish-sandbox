...
ROUTES = [
    {
        "title": "1 — Poll And Score Remits (Overview)",
        "route": "1-poll-and-score-remits",
    ...
    {
        "title": "2 — Route Remit Decisions",
        "route": "2-route-remit-decisions",
        "file": "route2.png",
