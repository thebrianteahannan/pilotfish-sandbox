...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://ACORD.org/Standards/Life/2" xmlns:converter="xalan://com.pilotfish.eip.transform.ConverterProxy" xmlns:datetime="http://exslt.org/dates-and-times" xmlns:dtFormatter="xalan://com.pilotfish.eip.gui.mapper.util.DateTimeFormatter" xmlns:ns2="http://ACORD.org/Standards/Life/2" xmlns:ta="xalan://com.pilotfish.eip.TransactionAttributes" xmlns:td="xalan://com.pilotfish.eip.TransactionData" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="converter datetime dtFormatter ta td ns2 xsl xsi xsd" extension-element-prefixes="converter" version="1.0" xsi:schemaLocation="http://ACORD.org/Standards/Life/2 TXLife2.20.02.xsd">
  ...
  <xsl:template match="ns2:StatusEventCode">
    <StatusEventCode tc="2147483647">Other</StatusEventCode>
  </xsl:template>
  <!--
	<xsl:template match="ns2:StatusEventTime">
		<StatusEventTime><xsl:call-template name="format-time"><xsl:with-param name="time" select="." /></xsl:call-template></StatusEventTime>
	</xsl:template>
	<xsl:template match="ns2:TransExeTime">
		<TransExeTime><xsl:call-template name="format-time"><xsl:with-param name="time" select="." /></xsl:call-template></TransExeTime>
	</xsl:template>
	-->
