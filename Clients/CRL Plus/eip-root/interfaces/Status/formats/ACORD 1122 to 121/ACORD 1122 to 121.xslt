...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:converter="xalan://com.pilotfish.eip.transform.ConverterProxy" xmlns:datetime="http://exslt.org/dates-and-times" xmlns:dtFormatter="xalan://com.pilotfish.eip.gui.mapper.util.DateTimeFormatter" xmlns:ns1="http://ACORD.org/Standards/Life/2" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="ns1 converter datetime dtFormatter" extension-element-prefixes="converter" version="1.0">
  ...
  <xsl:template match="ns1:TXLife">
    <TXLife schemaLocation="http://ACORD.org/Standards/Life/2 TXLife2.21.90.xsd">
      <UserAuthRequest>
        <UserLoginName />
        <UserPswd>
      ...
      <TXLifeRequest>
        ...
        <OLifE>
          ...
          <Holding id="{ns1:TXLifeRequest/ns1:OLifE/ns1:Holding/@id}">
            <Policy CarrierPartyID="{ns1:TXLifeRequest/ns1:OLifE/ns1:Holding/ns1:Policy/@CarrierPartyID}" id="{ns1:TXLifeRequest/ns1:OLifE/ns1:Holding/ns1:Policy/@id}">
              <PolNumber>
                <xsl:value-of select="ns1:TXLifeRequest/ns1:OLifE/ns1:Holding/ns1:Policy/ns1:PolNumber" />
              </PolNumber>
              <LineOfBusiness tc="1">Life</LineOfBusiness>
              <Jurisdiction tc="{ns1:TXLifeRequest/ns1:OLifE/ns1:Holding/ns1:Policy/ns1:Jurisdiction/@tc}">
                <xsl:value-of select="ns1:TXLifeRequest/ns1:OLifE/ns1:Holding/ns1:Policy/ns1:Jurisdiction" />
              </Jurisdiction>
              <EffDate>
                <xsl:value-of select="ns1:TXLifeRequest/ns1:OLifE/ns1:Holding/ns1:Policy/ns1:EffDate" />
              </EffDate>
              ...
              <ProductType id="{ns1:TXLifeRequest/ns1:OLifE/ns1:Holding/ns1:Policy/ns1:ProductType/@tc}">
                <xsl:value-of select="ns1:TXLifeRequest/ns1:OLifE/ns1:Holding/ns1:Policy/ns1:ProductType" />
              </ProductType>
              <Life>
                <!-- Copy the Life node -->
              ...
              <ApplicationInfo>
                ...
                <xsl:choose>
                  <xsl:when test="ns1:TXLifeRequest/ns1:OLifE/ns1:Holding/ns1:Policy/ns1:ApplicationInfo/ns1:ApplicationJurisdiction/text()">
                    <ApplicationJurisdiction tc="{ns1:TXLifeRequest/ns1:OLifE/ns1:Holding/ns1:Policy/ns1:ApplicationInfo/ns1:ApplicationJurisdiction/@tc}">
                      <xsl:value-of select="ns1:TXLifeRequest/ns1:OLifE/ns1:Holding/ns1:Policy/ns1:ApplicationInfo/ns1:ApplicationJurisdiction" />
                ...
                <PrefLanguage tc="{ns1:TXLifeRequest/ns1:OLifE/ns1:Holding/ns1:Policy/ns1:ApplicationInfo/ns1:PrefLanguage/@tc}">
                  <xsl:value-of select="ns1:TXLifeRequest/ns1:OLifE/ns1:Holding/ns1:Policy/ns1:ApplicationInfo/ns1:PrefLanguage" />
                </PrefLanguage>
              </ApplicationInfo>
              <RequirementInfo RequesterPartyID="Party_Carrier">
                ...
                <RequirementAcctNum>
                  <xsl:call-template name="TabularMapping_RequirementAcctNum_Mapping">
                    <xsl:with-param name="value" select="ns1:TXLifeRequest/ns1:OLifE/ns1:Holding/ns1:Policy/ns1:RequirementInfo[1]/ns1:RequirementAcctNum" />
                  </xsl:call-template>
                </RequirementAcctNum>
              </RequirementInfo>
            </Policy>
