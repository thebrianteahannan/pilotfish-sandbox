...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="3.1">
  <xsl:template match="/XCSData">
    <XCSExcelBook>
      <XCSExcelSheet name="Export_MUE_Edits_MultipleInsPlans_Report">
        <XCSExcelRow>
        ...
        <xsl:for-each select="Import/Group[@stripped = 'false']">
          <xsl:if test="(count(Insurance1/adminspolicy) + count(Insurance2/adminspolicy) + count(Insurance3/adminspolicy)) &gt; 1">
            <XCSExcelRow>
              <AccountNumber>
