...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="3.1">
  ...
  <xsl:template match="Charge">
    ...
    <xsl:variable name="stripLocationsCount" select="count(/XCSData/query_results/LOCATION/LOCATION[LOC_MNEMONIC = $admLocation and SOFTWARE_ID = $SoftwareID]) + (if ($Partition = 'HAL' and $admLocation = ('HMC 201','HH IPM','TL GI','TLGI','OR TL')) then 1 else 0)" />
