    ...
    <XCSData>
      ...
      <xsl:for-each select="//Group">
        <Group key="{@key}">
          ...
          <PatientDemographics>
            <absadmitdiag>
              <xsl:value-of select="Demographics/XCSRecord[1]/PRIM_DX_CODE" />
            </absadmitdiag>
            <admpatstate>
              ...
              <xsl:variable name="AdmitDate">
                <xsl:choose>
                  <xsl:when test="string-length(Demographics/XCSRecord[1]/ADM_DATE_TIME) != 10">
                    ...
                    <xsl:value-of select="pf:padDate(Demographics/XCSRecord[1]/ADM_DATE_TIME)" />
                  </xsl:when>
                  <xsl:otherwise>
                    <xsl:value-of select="Demographics/XCSRecord[1]/ADM_DATE_TIME" />
                  </xsl:otherwise>
                </xsl:choose>
              </xsl:variable>
            ...
            <admLocation>
              <xsl:value-of select="Demographics/XCSRecord[1]/DEPARTMENT_ABBR" />
            </admLocation>
            <admpatsex>
            ...
            <admpatienttype>
              <xsl:choose>
                <xsl:when test="contains(Demographics/XCSRecord[1]/BASE_CLASS,'IP')">
                  <xsl:value-of select="'Inp'" />
                </xsl:when>
                <xsl:when test="contains(Demographics/XCSRecord[1]/BASE_CLASS,'OP')">
                  <xsl:value-of select="'Out'" />
                </xsl:when>
                <xsl:when test="contains(Demographics/XCSRecord[1]/BASE_CLASS,'ED')">
          ...
          <!-- Diagnosis Codes -->
          <DiagnosisCodes>
            <xsl:if test="Demographics/XCSRecord[1]/PRIM_DX_CODE">
              <Diag>
                <xsl:value-of select="Demographics/XCSRecord[1]/PRIM_DX_CODE" />
              </Diag>
            </xsl:if>
            <xsl:if test="Demographics/XCSRecord[1]/DX02">
              <Diag>
                <xsl:value-of select="Demographics/XCSRecord[1]/DX02" />
              </Diag>
            </xsl:if>
            <xsl:if test="Demographics/XCSRecord[1]/DX03">
              <Diag>
                <xsl:value-of select="Demographics/XCSRecord[1]/DX03" />
              </Diag>
            </xsl:if>
            <xsl:if test="Demographics/XCSRecord[1]/DX04">
              <Diag>
                <xsl:value-of select="Demographics/XCSRecord[1]/DX04" />
              </Diag>
            </xsl:if>
            <xsl:if test="Demographics/XCSRecord[1]/DX05">
              <Diag>
                <xsl:value-of select="Demographics/XCSRecord[1]/DX05" />
              </Diag>
            </xsl:if>
            <xsl:if test="Demographics/XCSRecord[1]/DX06">
              <Diag>
                <xsl:value-of select="Demographics/XCSRecord[1]/DX06" />
              </Diag>
            </xsl:if>
            <xsl:if test="Demographics/XCSRecord[1]/DX07">
              <Diag>
                <xsl:value-of select="Demographics/XCSRecord[1]/DX07" />
              </Diag>
            </xsl:if>
            <xsl:if test="Demographics/XCSRecord[1]/DX08">
              <Diag>
                <xsl:value-of select="Demographics/XCSRecord[1]/DX08" />
              </Diag>
            </xsl:if>
          </DiagnosisCodes>
          ...
          <Insurance1>
            ...
            <absPatientUnit />
            <admInsName>
              <xsl:value-of select="Demographics/XCSRecord[1]/PRIM_PAYOR_PLAN_NAME" />
            </admInsName>
            <admAcctNum />
            <adminsinsuredrel>
              <xsl:value-of select="Demographics/XCSRecord[1]/PRIM_COV_REL_TO_SUB" />
            </adminsinsuredrel>
            <adminsstreet>
            ...
            <adminsmne>
              <xsl:choose>
                <xsl:when test="string-length(Demographics/XCSRecord[1]/PRIMARY_PLAN_ID) != 0">
          ...
          <Insurance2>
            ...
            <absPatientUnit />
            <admInsName>
              <xsl:value-of select="Demographics/XCSRecord[1]/SEC_PAYOR_PLAN_NAME" />
            </admInsName>
            <admAcctNum />
            <adminsinsuredrel>
              <xsl:value-of select="Demographics/XCSRecord[1]/SEC_COV_REL_TO_SUB" />
            </adminsinsuredrel>
            <adminsstreet>
