    ...
    <XCSData>
      <ADT_A22>
        ...
        <PV1>
          ...
          <xsl:variable name="LEVEL1CODE" select="substring(substring-before(TOLOCATION,'-'),1,10)" />
          <xsl:variable name="LEVEL2CODE" select="substring-before(substring-after(substring-after(TOLOCATION,$LEVEL1CODE),'-'),'-')" />
          <xsl:variable name="LEVEL3CODE" select="substring-before(substring-after(substring-after(TOLOCATION,$LEVEL2CODE),'-'),'-')" />
          <PV1.3>
            <PL.1>
