    ...
    <XCSData>
      <ADT_A21>
        ...
        <PV1>
          ...
          <!--new location info - NOT REQUIRED-->
          <PV1.3>
            <!--<PL.1>-->
          ...
          <PV1.4 />
          <PV1.5 />
          <!--prior location info - NOT REQUIRED-->
          <PV1.6>
            <!--<PL.1>-->
            <!--<xsl:value-of select="FROMLEVEL1CODE" />-->
            <!--</PL.1>-->
            <!--<PL.2>-->
            <!--<xsl:value-of select="FROMLEVEL2CODE" />-->
            <!--</PL.2>-->
            <!--<PL.3>-->
            <!--<xsl:value-of select="FROMLEVEL3CODE" />-->
            <!--</PL.3>-->
          </PV1.6>
          <PV1.7 />
          <PV1.8 />
