  ...
  <xsl:template match="/">
    <XCSData>
      <Group key="">
        <Unknown />
        <Header>
          <FacilityName>PPA - Precision Pathology Associates</FacilityName>
        </Header>
      </Group>
        ...
        <Group key="{@key}">
          ...
          <PatientDemographics>
            ...
            <absAdmitdate>
              <xsl:variable name="AdmitDate">
                <xsl:choose>
                  <xsl:when test="string-length(Demographics/XCSRecord[1]/ADM_DATE) != 10">
            ...
            <absattendingdocmnem />
            <absattendingdocname>
              <xsl:value-of select="Demographics/XCSRecord[1]/ATTEND_PROV" />
            </absattendingdocname>
            <admemplstreet />
            <admAcctNum>
              <xsl:value-of select="Demographics/XCSRecord[1]/HSP_ACCOUNT_ID" />
            </admAcctNum>
            <admbirthdate>
              <xsl:variable name="PatDOB">
                <xsl:choose>
                  <xsl:when test="string-length(v) != 10">
                    <!--WE KNOW WE NEED TO PAD WITH ZERO-->
            ...
            <admLocation>
              <xsl:value-of select="Demographics/XCSRecord[1]/LOC_NAME" />
            </admLocation>
            <admpatsex>
            ...
            <admpatienttype>
              <xsl:choose>
                <xsl:when test="contains(Demographics/XCSRecord[1]/BASE_CLASS,'Inpatient')">
                  <xsl:value-of select="'Inp'" />
                </xsl:when>
                <xsl:when test="contains(Demographics/XCSRecord[1]/BASE_CLASS,'Outpatient')">
                  <xsl:value-of select="'Out'" />
                </xsl:when>
                <xsl:when test="contains(Demographics/XCSRecord[1]/BASE_CLASS,'Emergency')">
          ...
          <xsl:for-each select="Charges/XCSRecord[QUANTITY]">
            <Charge>
              ...
              <radExamServDate>
                <xsl:if test="string-length(translate(SPECIMENCOLLECTIONDATE, '/', '')) != 0">
                  <xsl:variable name="CollectionDate">
                    <xsl:choose>
                      <xsl:when test="string-length(SPECIMENCOLLECTIONDATE) != 10">
                        <!--WE KNOW WE NEED TO PAD WITH ZERO-->
                        <xsl:value-of select="pf:padDate(SPECIMENCOLLECTIONDATE)" />
                      </xsl:when>
                      <xsl:otherwise>
                        <xsl:value-of select="SPECIMENCOLLECTIONDATE" />
                      </xsl:otherwise>
                    </xsl:choose>
                  </xsl:variable>
              ...
              <radExamCPT>
                <xsl:value-of select="PROCEDURECODECPT" />
              </radExamCPT>
              <examdesc>
          ...
          <Guarantor>
            ...
            <admGuarRel>
              <xsl:choose>
                <xsl:when test="string-length(Demographics/XCSRecord[1]/GUAR_REL_TO_PAT_ID) = 0">
                  <!--DEFAULT TO 15 IF THERE IS NO RELATION PATIEND ID-->
                  <xsl:value-of select="'15'" />
                </xsl:when>
                <xsl:otherwise>
                  <xsl:value-of select="Demographics/XCSRecord[1]/GUAR_REL_TO_PAT_ID" />
                </xsl:otherwise>
              </xsl:choose>
            </admGuarRel>
            <admGuarName>
          ...
          <DiagnosisCodes>
            <xsl:if test="Demographics/XCSRecord[1]/PRIM_DIAGNOSIS_CODE">
              <Diag>
                <xsl:value-of select="XCSRecord[1]/PRIM_DIAGNOSIS_CODE" />
              </Diag>
            </xsl:if>
            ...
            <xsl:if test="Demographics/XCSRecord[1]/SECONDARY_DIAG_CODE_9">
              <Diag>
                <xsl:value-of select="Demographics/XCSRecord[1]/SECONDARY_DIAG_CODE_9" />
              </Diag>
            </xsl:if>
            <xsl:if test="Demographics/XCSRecord[1]/SECONDARY_DIAG_CODE_10">
              <Diag>
                <xsl:value-of select="Demographics/XCSRecord[1]/SECONDARY_DIAG_CODE_10" />
              </Diag>
            </xsl:if>
            <xsl:if test="Demographics/XCSRecord[1]/SECONDARY_DIAG_CODE_11">
              <Diag>
                <xsl:value-of select="Demographics/XCSRecord[1]/SECONDARY_DIAG_CODE_11" />
              </Diag>
            </xsl:if>
            <xsl:if test="Demographics/XCSRecord[1]/SECONDARY_DIAG_CODE_12">
              <Diag>
                <xsl:value-of select="Demographics/XCSRecord[1]/SECONDARY_DIAG_CODE_12" />
              </Diag>
            </xsl:if>
            <xsl:if test="Demographics/XCSRecord[1]/SECONDARY_DIAG_CODE_13">
              <Diag>
                <xsl:value-of select="Demographics/XCSRecord[1]/SECONDARY_DIAG_CODE_13" />
              </Diag>
            </xsl:if>
            <xsl:if test="Demographics/XCSRecord[1]/SECONDARY_DIAG_CODE_14">
              <Diag>
                <xsl:value-of select="Demographics/XCSRecord[1]/SECONDARY_DIAG_CODE_14" />
              </Diag>
            </xsl:if>
            <xsl:if test="Demographics/XCSRecord[1]/SECONDARY_DIAG_CODE_15">
              <Diag>
                <xsl:value-of select="Demographics/XCSRecord[1]/SECONDARY_DIAG_CODE_15" />
              </Diag>
            </xsl:if>
            <xsl:if test="Demographics/XCSRecord[1]/SECONDARY_DIAG_CODE_16">
              <Diag>
                <xsl:value-of select="Demographics/XCSRecord[1]/SECONDARY_DIAG_CODE_16" />
              </Diag>
            </xsl:if>
            <xsl:if test="Demographics/XCSRecord[1]/SECONDARY_DIAG_CODE_17">
              <Diag>
                <xsl:value-of select="Demographics/XCSRecord[1]/SECONDARY_DIAG_CODE_17" />
              </Diag>
            </xsl:if>
            <xsl:if test="Demographics/XCSRecord[1]/SECONDARY_DIAG_CODE_18">
              <Diag>
                <xsl:value-of select="Demographics/XCSRecord[1]/SECONDARY_DIAG_CODE_18" />
              </Diag>
            </xsl:if>
            <xsl:if test="Demographics/XCSRecord[1]/SECONDARY_DIAG_CODE_19">
              <Diag>
                <xsl:value-of select="Demographics/XCSRecord[1]/SECONDARY_DIAG_CODE_19" />
              </Diag>
            </xsl:if>
            <xsl:if test="Demographics/XCSRecord[1]/SECONDARY_DIAG_CODE_20">
              <Diag>
                <xsl:value-of select="Demographics/XCSRecord[1]/SECONDARY_DIAG_CODE_20" />
              </Diag>
            </xsl:if>
          </DiagnosisCodes>
          ...
          <Insurance1>
            ...
            <adminspolicy>
              <xsl:value-of select="Demographics/XCSRecord[1]/PRIM_COV_SUBSCR_NUM" />
            </adminspolicy>
            <subscribername>
              <xsl:value-of select="Demographics/XCSRecord[1]/PRIM_COV_SUBSCR_NAME" />
            </subscribername>
            <adminszip>
            ...
            <absPatientUnit />
            <admInsName>
              <xsl:value-of select="Demographics/XCSRecord[1]/PRIMARY_PLAN_NAME" />
            </admInsName>
            <admAcctNum />
            <adminsinsuredrel>
              <xsl:value-of select="Demographics/XCSRecord[1]/PRIM_COV_REL_TO_SUB_ID" />
            </adminsinsuredrel>
            <adminsstreet>
            ...
            <authnumber>
              <xsl:value-of select="Demographics/XCSRecord[1]/AUTHNUMBER" />
            </authnumber>
          </Insurance1>
          <Insurance2>
            <adminsstate>
            ...
            <subscribername>
              <xsl:value-of select="Demographics/XCSRecord[1]/SEC_COV_SUBSCR_NAME" />
            </subscribername>
            <adminszip>
            ...
            <absPatientUnit />
            <admInsName>
              <xsl:value-of select="Demographics/XCSRecord[1]/SEC_PLAN_NAME" />
            </admInsName>
            <admAcctNum />
            <adminsinsuredrel>
              <xsl:value-of select="Demographics/XCSRecord[1]/SEC_COV_REL_TO_SUB_ID" />
            </adminsinsuredrel>
            <adminsstreet>
